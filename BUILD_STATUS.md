...
| `npm test` | 51 of 51 pass: 45 unit/queue, 6 stdio integration |
...
2. Install on the target Codex machine with a separately installed Node 22.13+, so the path does not change on Codex updates.
