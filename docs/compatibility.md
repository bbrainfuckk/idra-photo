...
- If Codex runs on the Node it bundles, that path contains a hash and can change on Codex updates. Installing Node separately avoids re-running `install-codex`.
